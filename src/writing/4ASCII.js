  ...
  return (
    <div>
      ...
      <p>
        ...
        characters from all the languages in the world. Each of these characters
        has its own unique number assigned to it, and we call these numbers
        ...
        <p className="text-gray-700 text-justify mt-2">
          ...
          <p className="text-gray-700 text-justify mt-4">
            ...
            <div className="text-xl text-center mt-1">
              ...
              ×2
              <sup>1</sup> +<span className="bg-orange-500 rounded-lg">1</span>{" "}
              × 2<sup>0</sup> = 5.
            </div>
          </p>
        </p>
